...
The Surface Salinity value is currently **`r current_vs_mean_text` the long-term mean**, and has been **since `r streak_start_date`**.
The regional salinity value has followed a **`r current_trend` trend** in recent years (Fig \@ref(fig:plot-azmp-salinity)).
