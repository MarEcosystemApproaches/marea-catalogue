...
p %>%
  layout(
    title = "AZMP SST by Region",
    xaxis = list(title = "Year"),
    yaxis = list(title = "Sea Surface Temperature (°C)", fixedrange = TRUE),
    hovermode = "x unified",
    legend = list(
      tracegroupgap = 5,
...
The overall trend is **`r majority_trend` temperature** across regions. `r n_increasing` regional subdivisions have increasing Bottom Temperature trends (`r n_increasing_sig` statistically significant) and `r n_decreasing` have negative trends (Fig \@ref(fig:plot-trends-azmp-satellite-temperature)).
