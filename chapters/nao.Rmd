...
|Timeseries Record High | `r highest_val` | The highest value in the timeseries was recorded on **`r highest_timepoint`**, and was **`r highest_mean_diff`** higher than the overall timeseries mean. |
|Timeseries Record Low | `r lowest_val` | The lowest value in the timeseries was recorded on **`r lowest_timepoint`**, and was **`r lowest_mean_diff`** lower than the overall timeseries mean. |
