...
# find current values
current_trend <- ifelse(last_ten_slope > 0,"an increasing", "a decreasing")
current_magnitude <-
...
Stratification in the Scotian Shelf region has shown **`r current_trend` trend** in recent years, and broadly throughout the time series. 
