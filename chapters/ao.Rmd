...
<!---------- Trends Text ----------->
As of the most recent data entry in **`r last_date`**, the AO value is `r last_val`, which is **`r current_magnitude`** among values in the timeseries.
The AO is **currently in a `r current_phase` phase**, and has been since `r streak_start_date`.
