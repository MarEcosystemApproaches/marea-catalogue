...
|Timeseries Record High | `r round(highest_val,2)` | The highest value in the timeseries was recorded in **`r highest_timepoint`**. |
|Timeseries Record Low | `r round(lowest_val,2)` | The lowest value in the timeseries was recorded in **`r lowest_timepoint`**. |
