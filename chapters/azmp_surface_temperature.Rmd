...
AZMP Surface Temperature contains empirical temperature measurements at 0m depth, averaged across NAFO divisions (4V, 4X, 4W) and regional boundaries (Bay of Fundy + Gulf of Maine). Data from this indicator is not subdivided regionally, but see Chapter \@ref(azmp-satellite-temperature) for spatially-stratified surface temperature data. 
